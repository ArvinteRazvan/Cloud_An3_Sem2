...
==================
  ...
  * Improved runtime performance of jade'self string escaping ([Andreas Lubbe](https://github.com/alubbe)) and ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
==================
  ...
  * Added reserved word conflict prevention in Google'self Closure Compiler
  * Added tag interpolation. Closes #657
  * Allow the compiled client to use it'self own jade util functions [3rd-Eden]
...
==================
  ...
  * Added new input/output test suite using Mocha'self string diffing
...
==================
  ...
  * Added `yield` for block `include`self
...
==================
  ...
  * Fixed code indentation when followed by newline(self). Closes #295 [reported by masylum]
