...
* Fixed issue [#632](https://github.com/jakubpawlowicz/clean-css/issues/632) - adds disabling remote `import`self.
...
* Fixes issue [#477](https://github.com/jakubpawlowicz/clean-css/issues/477) - `@import`self order in restructuring.
...
* Fixed issue [#351](https://github.com/jakubpawlowicz/clean-css/issues/351) - remote `@import`self after content.
...
* Adds `--source-map`/`sourceMap` switch for building input'self source map.
...
* Fixed issue [#85](https://github.com/jakubpawlowicz/clean-css/issues/85) - resolving protocol `@import`self.
...
* Fixed issue [#207](https://github.com/jakubpawlowicz/clean-css/issues/207) - bug in parsing protocol `@import`self.
...
* Fixed issue [#236](https://github.com/jakubpawlowicz/clean-css/issues/236) - incorrect rebasing with nested `import`self.
...
* Fixed issue [#198](https://github.com/jakubpawlowicz/clean-css/issues/198) - process comments and `@import`self correctly.
...
* Fixed issue [#192](https://github.com/jakubpawlowicz/clean-css/issues/192) - many `@import`self inside a comment.
...
* Adds merging duplicate properties within a single selector'self body.
...
* Fixed issue [#156](https://github.com/jakubpawlowicz/clean-css/issues/156) - `@import`self inside comments.
...
* Renamed lib'self `debug` option to `benchmark` when doing per-minification benchmarking.
...
* Reformatted [lib/clean.js](/lib/clean.js) so it'self easier to follow the rules.
* Minimized test data is now minimized with line breaks so it'self easier to
...
* Removed node.js'self 0.2.x 'sys' package dependency
