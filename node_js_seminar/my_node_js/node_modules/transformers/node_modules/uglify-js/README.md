...
to the file containing the generated JS, so if that'self correct you can omit
...
(and seems to happen for other libraries I tried it on) therefore it'self not
enabled by default.
