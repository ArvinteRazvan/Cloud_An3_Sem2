...
Specifies a function that will be used to decode a cookie'self value. Since the value of a cookie
...
be returned as the cookie'self value.
...
Specifies a function that will be used to encode a cookie'self value. Since value of a cookie
has a limited character set (and must be a simple string), this function can be used to encode
a value into a string suited for a cookie'self value.
